...
public class VerAsignado extends JFrame {

    private static final long serialVersionUID = 1L;
    private JPanel mainPanel;
    private JLabel nombreLabel, apellidoLabel, segundoIdLabel;
    public JTextField nombreTextField, apellidoTextField, clienteTextField, idProyTextField;
    ...
    public VerAsignado() {
        ...
        nombreLabel = new JLabel("Id cient:");
        ...
        segundoIdLabel = new JLabel("Id proy:");
        idProyTextField = new JTextField(25);
        ...
        constraints.gridy = 1;
        mainPanel.add(segundoIdLabel, constraints);
        constraints.gridy = 2;
        ...
        constraints.gridy = 1;
        mainPanel.add(idProyTextField, constraints);
        constraints.gridy = 2;
